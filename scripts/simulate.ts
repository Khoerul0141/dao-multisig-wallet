...
class IntegratedWalletSimulator {
  ...
  async initialize(): Promise<void> {
    ...
    console.log("🔗 Using deploy.ts for contract deployment");
    ...
    console.log("\n" + "═".repeat(60));
    console.log("🔹 DEPLOYMENT PHASE (using deploy.ts)");
...
async function main(): Promise<any> {
  ...
  console.log("📚 Using deploy.ts for consistent contract deployment");
